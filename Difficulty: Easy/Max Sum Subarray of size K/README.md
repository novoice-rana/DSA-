<h2><a href="https://www.geeksforgeeks.org/problems/max-sum-subarray-of-size-k5313/1#expected-approach-using-sliding-window-on-time-o1-space">Max Sum Subarray of size K</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array of integers<strong> arr[]&nbsp;</strong> and a number<strong> k</strong>. Return&nbsp;the maximum sum of a subarray of size k.</span></p>
